...
The FuraOJ comes with an online interface for creating and editing problem statements as well as data.
...
Here you may edit your problem statement. The FuraOJ features a rich Markdown-based syntax, with custom extensions for LaTeX-based display
math, and Mathjax-based inline math. See [this template](https://raw.githubusercontent.com/furavietnam/furaoj-docs/master/sample_files/problem_markdown_example.md.txt) for a full feature example (you may copy/paste
...
Internally, the FuraOJ uses a YAML-based format for describing problem data, which you may read about [here](/problem_format/problem_format.md#problem-format).
