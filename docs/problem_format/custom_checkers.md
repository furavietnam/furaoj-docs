...
The FuraOJ judge already defines several checkers.
...
~~The only built-in checker that has this flag set is the `linecount` checker.~~ (Removed in [this commit](https://github.com/furavietnam/judge-server/commit/d0336f681f1bbf52a5e133a05ce2a2f8a78dc2d5))
