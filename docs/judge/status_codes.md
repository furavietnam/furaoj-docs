...
Your program caused a runtime error to occur. This will only occur for native languages like C or C++. FuraOJ maps many common RTEs to more useful descriptions, described below.
...
| `{} syscall disallowed` | Unless you are doing something of a dubious nature, you should never see this message. If you do, please [submit an issue](https://github.com/furavietnam/judge-server/issues) so we can get it sorted out. It is raised when your program attempts to use a disallowed system call. |
